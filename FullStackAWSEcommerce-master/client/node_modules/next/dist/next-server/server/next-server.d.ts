...
import { DomainLocales, NextConfig } from 'next/dist/next-server/server/config';
import Router, { DynamicRoutes, PageChecker, Params, Route } from 'next/dist/next-server/server/router';
import 'next/dist/next-server/server/node-polyfill-fetch';
import { PagesManifest } from 'next/dist/build/webpack/plugins/pages-manifest-plugin';
import { FontManifest } from 'next/dist/next-server/server/font-utils';
